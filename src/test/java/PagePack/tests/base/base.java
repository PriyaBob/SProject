...
import PagePack.util.ExtentManager;
...
public class base {
	...
	public void openBrowser(String browserType) {
		...
		eTest.log(LogStatus.INFO,"Successfully opened "+ browserType);
...
public void reportFail(String message) {
	...
	takeScreenshot(); //the test case fail it will screenshot
	Assert.fail(message);
